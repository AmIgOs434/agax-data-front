...
function Sort_by_razdel1({e2,dogovor,setbal,setbalRef}) {
...
<div class=' col1 dogovor_ f_w ple'>
{((setrashod1Ref?.current-setprihod1Ref?.current)+(setrashod2Ref?.current-setprihod2Ref?.current))?.toLocaleString(undefined, {
  minimumFractionDigits: 2,
  maximumFractionDigits: 2
}) } ₽
</div>
...
export default Sort_by_razdel1;
