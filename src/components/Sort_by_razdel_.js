...
import Sort_by_razdel_1 from './Sort_by_razdel_1';
function Sort_by_razdel_() {
...
<div class='dfdfs'>
        Баланс ЛС: По разделам (с нарастающим итогом)
        </div>
      </div>
...
<Sort_by_razdel_1 setbal={setbal} setbalRef={setbalRef} e2={e1[Object.keys(e1)[0]]} dogovor={Object.keys(e1)[0]} />
...
export default Sort_by_razdel_;
